...
Поля:
- title: короткое название на русском (2–5 слов), например «Белая хлопковая рубашка»
...
Если не уверен — выбери ближайшие значения из списков, не выдумывай новые категории.
''';

  Future<ClothingVisionAnalysis> analyzeClothingImage(String imagePath) async {
    ...
    return ClothingVisionAnalysis.fromJson(json);
  }
